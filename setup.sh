...
check() {
    ...
    echo CONSUL=webconsole-images-consul.svc.${TRITON_ACCOUNT}.${TRITON_DC}.${TRITON_DOMAIN} >> .consul.env
    ...
    echo '# Site URL' > .env
    echo BASE_URL=https://webconsole-images.svc.${TRITON_ACCOUNT}.${TRITON_DC}.triton.zone >> .env
    ...
    echo CONSUL=webconsole-images-consul.svc.${TRITON_ACCOUNT}.${TRITON_DC}.${TRITON_DOMAIN} >> .env
